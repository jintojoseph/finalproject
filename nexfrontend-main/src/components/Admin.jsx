...
const Admin = () => {
  ...
  const correctUsername = 'admin@example.com';
  ...
  const handleSubmit = (e) => {
    ...
    if (form.Email === correctUsername && form.Password === correctPassword) {
      setError('');
      console.log('Form Submitted:', form);
      navigate('/groups'); // Navigate after successful authentication
    } else {
